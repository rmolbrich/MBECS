...
```{r HEAT}
print(params$report.list$heat$Base)
# Heatmap features of interest and description.
# version 1
# gridExtra::marrangeGrob(grobs=params$report.list$heat$Base, ncol = 2, nrow=2)
# or version 2
# gridExtra::grid.arrange(grobs=params$report.list$heat, ncol = 2)
