...
<img src="README_files/figure-gfm/logo_LIED.png" alt="Luebeck Institute for Experimental Dermatology" align="left" width="206" height="83"/>

<img src="README_files/figure-gfm/logo_Uni.png" alt="University of Luebeck" align="right" width="206" height="83"/><br><br><br>
...
So, PCA, boxplots, ..., linear modelling, ...
Based on this we need a mitigation stage where we decide whether to apply BECA and which one (which method is best suited).
