...
# or version 2
# gridExtra::grid.arrange(grobs=params$report.list$pca, ncol = 2)
...
# or version 2
# gridExtra::grid.arrange(grobs=post.report.list$rle, ncol = 2)
#plot(bla$report.list$rle)
...
# FixMe: implement some logic to organize and format these plots
gridExtra::marrangeGrob(grobs=params$report.list$box$pre, ncol = 2, nrow=2)

#c("ruv3","bmc","bat","rbe","pn","svd")
if( "ruv3" %in% p.names ) {
